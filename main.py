...
if __name__ == '__main__':
    ...
    how_many_search = 20 # указать после скольки найденных подходящих вакансий становить парсинг
    while total_get < how_many_search:
        time.sleep(0.5)
        vacancy_list_tag, vacancy_tags = get_html(url, 20, page, headers_gen.generate())
